...
import { Loader2, AlertCircle, LogIn, Lock } from 'lucide-react';
      ...
      >
        <motion.div variants={itemVariants} className="text-center">
          ...
          {redirectUrl && (
            ...
            >
              <AlertCircle size={16} /> Please sign in to continue.
            </motion.div>
          )}
        </motion.div>
          ...
          <motion.div variants={itemVariants} className="space-y-4">
            <div>
              ...
              <input 
                ...
                className="appearance-none block w-full px-4 py-3 border border-gray-300 rounded-xl placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-shadow sm:text-sm"
            ...
            <div>
              ...
              <div className="relative">
                <input 
                  ...
                  className="appearance-none block w-full px-4 py-3 border border-gray-300 rounded-xl placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-shadow sm:text-sm pr-10"
                  placeholder="••••••••"
                />
        ...
        <motion.div variants={itemVariants} className="text-center pt-2">
          <Link href="/signup" className="text-sm text-gray-600 hover:text-blue-600 font-medium transition-colors">
